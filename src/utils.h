...
namespace SCREEN
{
    static constexpr const QSize LOGICAL_SIZE  = QSize(768, 768);
...
namespace SETTINGS
{
static const QSize CELL_SIZE = QSize(SCREEN::PHYSICAL_SIZE.width()/3, SCREEN::PHYSICAL_SIZE.height()/3);
}

namespace COLOR_STYLE
{
    static const QColor GREEN3     = QColor(15 ,  56, 15);
    static const QColor GREEN2     = QColor(48 ,  98, 48);
    static const QColor GREEN1     = QColor(139, 172, 15);
    static const QColor GREEN0     = QColor(155, 188, 15);
